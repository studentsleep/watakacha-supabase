        ...
        <div class="inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full" role="document">
            <form action="{{ route('manager.photographers.store') }}" method="POST">
                ...
                <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-gray-100">เพิ่มช่างภาพ</h3>
                    <div class="mt-4 space-y-4">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div>
                                <x-input-label for="email_pg" :value="__('Email')" />
                ...
                <div class="bg-gray-50 dark:bg-gray-700 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    ...
                    <x-secondary-button type="button" class="mt-3 sm:mt-0" onclick="toggleModal('addPhotographerModal', false)">ยกเลิก</x-secondary-button>
                </div>
            </form>
        </div>
    </div>
