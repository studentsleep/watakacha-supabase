                ...
                <form :action="formActionUrl" method="POST">
                    ...
                    <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        ...
                        <div class="mt-4 space-y-4">
                            <div>
                                <label for="item_type_name" class="block text-sm font-medium text-gray-700 dark:text-gray-300">ประเภทสินค้า</label>
                            ...
                            <div>
                                <label for="item_type_description" class="block text-sm font-medium text-gray-700 dark:text-gray-300">คำอธิบาย</label>
                    ...
                    <div class="bg-gray-5 dark:bg-gray-700 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
...
<script>
    // ใช้ Logic เดียวกันกับ Item Units
    // การเช็ค typeof จะช่วยป้องกัน error หากมีการโหลด partial นี้ซ้ำ หรือโหลดร่วมกับ units
